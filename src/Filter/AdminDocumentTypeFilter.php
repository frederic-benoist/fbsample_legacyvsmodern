...
namespace FBenoist\FbSampleLegacyVsModern\Filter;

use PrestaShop\PrestaShop\Core\Search\Filters;

/**
 * Class CustomerStateFilter proves default filters for our groups grid
 */
final class AdminDocumentTypeFilter extends Filters
{
    /**
     * {@inheritdoc}
     */
